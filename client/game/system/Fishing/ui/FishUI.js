...
export default class FishUI {
  ...
  static preloadFireSprites(scene) {
    scene.load.spritesheet(
      "fire-common",
      "./assets/Game/Fishing/fireSprites/192/greenWarp.png",
      {
        frameWidth: 192,
        frameHeight: 192,
      }
    ...
    scene.load.spritesheet(
      "fire-uncommon",
      "./assets/Game/Fishing/fireSprites/192/blueWarp.png",
      {
        frameWidth: 192,
        frameHeight: 192,
      }
    ...
    scene.load.spritesheet(
      "fire-rare",
      "./assets/Game/Fishing/fireSprites/192/pinkWarp.png",
      {
        frameWidth: 192,
        frameHeight: 192,
      }
    ...
    scene.load.spritesheet(
      "fire-epic",
      "./assets/Game/Fishing/fireSprites/192/redWarp.png",
      {
        frameWidth: 192,
        frameHeight: 192,
      }
    ...
    scene.load.spritesheet(
      "fire-legendary",
      "./assets/Game/Fishing/fireSprites/192/yellowWarp.png",
      {
        frameWidth: 192,
        frameHeight: 192,
      }
