...
export default class GameBarUI {
  ...
  static preload(scene) {
    scene.load.image("gameBar", "./assets/Game/Hud/GameBar/bodyBar.png");
    scene.load.image("sendButton", "./assets/Game/Hud/GameBar/sendButton.png");
    scene.load.image(
      "settingsButton",
      "./assets/Game/Hud/GameBar/settingsButton.png"
    );
    scene.load.image(
      "tackleBoxButton",
      "./assets/Game/Hud/GameBar/tackleButton.png"
    );
    scene.load.image(
      "backpackButton",
      "./assets/Game/Hud/GameBar/backpackButton.png"
    );
    scene.load.image(
      "fishdexButton",
      "./assets/Game/Hud/GameBar/fishdexButton.png"
    );
    scene.load.image("exitButton", "./assets/Game/Hud/GameBar/exitButton.png");
  }
