...
import AdvancedRod from "../../system/item/items/AdvancedRod.js";
...
export default class ShopUI {
  ...
  static preload(scene) {
    scene.load.image("shopBg", "./assets/Game/Shop/shopBg.png");
    scene.load.image("item", "./assets/Game/Shop/item.png");
    scene.load.image("rodReelTab", "./assets/Game/Shop/rodReelTab.png");
    scene.load.image("lineTackleTab", "./assets/Game/Shop/lineTackleTab.png");
    scene.load.image("lureBaitTab", "./assets/Game/Shop/lureBaitTab.png");
  }
